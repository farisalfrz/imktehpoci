...
<body class="d-flex align-items-center" style="background-color: #edba22; height: 100vh">
  <div class="container" style="width: 30%">
    <div class="card">
      <div class="card-body">
        <form action="ubah-produk.php" method="POST">
          <input type="text" style="display: none;" name="produkID" value="<?php echo $produkID ?>">
          <h2 class="card-title" style="color: #01733f">Ubah Produk</h2>
          <label class="form-label mt-5">Nama Produk</label>
          <input type="text" class="form-control" name="nama_produk" value="<?php echo $row['nama_produk'] ?>" />
          <label class="form-label mt-4">Harga</label>
          <input type="number" class="form-control" name="harga" value="<?php echo $row['harga'] ?>" />
          <label class="form-label mt-4">Stok</label>
